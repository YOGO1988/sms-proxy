...
"""
=====================================================
CHRONOMETR Z TABLICĄ LED - KOMPLETNA WERSJA
=====================================================
...
class ChronometerManager:
    ...
    def setup_gui(self):
        ...
        led_config_frame.pack(fill=tk.X, padx=10, pady=5)
    ...
    def la_manual_finish(self):
        ...
        # Jeśli to ostatni zawodnik lub chcemy zakończyć bieg
        # (tutaj można dodać logikę sprawdzania czy wszyscy zawodnicy skończyli)
